...
const PaymentPage: React.FC = () => {
    ...
    const onClickSubmitButton = () => {
      ...
      console.log("clicked submit button");
      router.push("/mentor-booking/preference");
    }
  ...
  return (
    ...
    <div className="flex mb-4 p-4 rounded-2xl shadow-md w-full">
      <h2 className="text-2xl font-bold mb-4">Schedule Page</h2>
...
<CancelButton onClick={()=>onClickCancelButton()} text="Cancel" fullWidth={false}/>
